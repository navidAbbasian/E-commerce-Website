 ...
 * @group api
 */
class UpdateShopTest extends ApiTestCase
{
    protected string $endpoint = 'patch@v1/shops/{id}';
    ...
    // TODO TEST
    public function testUpdateExistingShop(): void
    {
        ...
        $response = $this->injectId($shop->id)->makeCall($data);
    ...
    public function testUpdateNonExistingShop(): void
    {
        $invalidId = 7777;
    ...
    // TODO TEST
//    public function testUpdateExistingShopWithEmptyValues(): void
//    {
//        $shop = Shop::factory()->create();
//        $data = [
