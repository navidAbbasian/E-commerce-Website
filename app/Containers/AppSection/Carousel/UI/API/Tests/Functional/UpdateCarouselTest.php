 ...
 * @group api
 */
class UpdateCarouselTest extends ApiTestCase
{
    protected string $endpoint = 'patch@v1/carousels/{id}';
    ...
    // TODO TEST
    public function testUpdateExistingCarousel(): void
    {
        ...
        $response = $this->injectId($carousel->id)->makeCall($data);
    ...
    public function testUpdateNonExistingCarousel(): void
    {
        $invalidId = 7777;
    ...
    // TODO TEST
//    public function testUpdateExistingCarouselWithEmptyValues(): void
//    {
//        $carousel = Carousel::factory()->create();
//        $data = [
