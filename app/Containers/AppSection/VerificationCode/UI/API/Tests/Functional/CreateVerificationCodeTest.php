...
/**
 * Class CreateVerificationCodeTest.
 *
 * @group verificationcode
 * @group api
 */
class CreateVerificationCodeTest extends ApiTestCase
{
    protected string $endpoint = 'post@v1/verification-codes';
    ...
    // TODO TEST
//    public function testCreateVerificationCodeWithInvalidFields(): void
//    {
//        $data = [
...
//    public function testGivenHaveNoAccess_CannotCreateVerificationCode(): void
//    {
