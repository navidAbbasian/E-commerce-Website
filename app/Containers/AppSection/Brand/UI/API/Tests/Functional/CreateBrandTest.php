 ...
 * @group api
 */
class CreateBrandTest extends ApiTestCase
{
    protected string $endpoint = 'post@v1/brands';
    ...
    // TODO TEST
//    public function testCreateBrandWithInvalidFields(): void
//    {
//        $data = [
...
//    public function testGivenHaveNoAccess_CannotCreateBrand(): void
//    {
